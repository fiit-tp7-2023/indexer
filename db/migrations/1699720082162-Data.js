module.exports = class Data1699720082162 {
    name = 'Data1699720082162'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "nft_entity" ("id" character varying NOT NULL, "token_id" numeric NOT NULL, "name" text, "description" text, "image" text, "animation_url" text, "external_url" text, "attributes" jsonb, "uri" text, "raw" jsonb, "nft_collection_id" character varying, CONSTRAINT "PK_ed09c6a38c0f0a867d5a7b63f0d" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "nft_collection_entity" ("id" character varying NOT NULL, "address" text NOT NULL, "blockchain" character varying(7) NOT NULL, "contract_type" character varying(7), "owner" text, "symbol" text, "name" text, "description" text, "image" text, "external_link" text, "uri" text, "raw" jsonb, "base_uri" text, CONSTRAINT "PK_3691f573a8498c8dab00d7a421c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "token_transfer_entity" ("id" character varying NOT NULL, "from_address" text NOT NULL, "to_address" text NOT NULL, "amount" numeric NOT NULL, "token_id" character varying, CONSTRAINT "PK_dcae18ea60c726748b6efa8408c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "token_collection_entity" ("id" character varying NOT NULL, "address" text NOT NULL, "blockchain" character varying(7) NOT NULL, "contract_type" character varying(7), "owner" text, "symbol" text, "name" text, "decimals" numeric, "logo" text, "thumbnail" text, "raw" jsonb, CONSTRAINT "PK_9db5abbc6f3bd67a6563dcbe494" PRIMARY KEY ("id"))`)
